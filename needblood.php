...
<body>
 <?php 
  ...
  <div> <select class="form-control" name="bloodgroup">
...
<?php if(isset($_POST['search'])){
  ...
  $bg=$_POST['bloodgroup'];
  $sql= "select * from becomedonar join bloodgroup where becomedonar.bloodgroup=bloodgroup.Id AND bloodgroup='{$bg}' order by rand() limit 5";
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      <div class="card" style="width:300px">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              <b>Blood Group : </b> <b><?php echo $row['bloodgroup']; ?></b><br>
              <b>Mobile No. : </b> <?php echo $row['phno']; ?><br>
